...
function visualizeMatchesPlayedPerYear(matchesPlayedPerYear) 
{
  ...
  Highcharts.chart("matches-played-per-year", {
   chart: {
    ...
    title: {
      text: "(ii) Total no. of matches played per year" 
    },
    subtitle: {
      text:
        'Source: <a href="https://www.kaggle.com/nowke9/ipldata/data">IPL Dataset</a>'
...
function visualizeMatchesWonByEachTeam(data)
{
    ...
    Highcharts.chart('matches-won-by-each-team', {
      ...
      title: {
          text: ' (iii) No. of matches won by each team over all the years of IPL'
      },
      subtitle: {
...
var chart =  Highcharts.chart("extra-runs", {
    ...
    title: {
      text: " (iv) Extra runs conceded by each team in 2016"
    },
    subtitle: {
      text:
        'Source: <a href="https://www.kaggle.com/nowke9/ipldata/data">IPL Dataset</a>'
...
function visualizeEconomyBowlers(data)
{
  Highcharts.chart("economy-bowlers", {
    ...
    title: {
      text: "(v) Top 10 Economical Bowlers in 2015"
    },
    subtitle: {
      text:
        'Source: <a href="https://www.kaggle.com/nowke9/ipldata/data">IPL Dataset</a>'
